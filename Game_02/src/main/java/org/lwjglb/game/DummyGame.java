...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        house.setPosition(0.0f, -14.0f, 3.0f);
        ...
        terrain.setPosition(0.00f, -14.000f, 0.000f); // TODO set background to -15.000
...
//            Mesh[] addMesh = StaticMeshesLoader.load("src/main/resources/models/russ/russ9.obj", "src/main/resources/models/russ");
    ...
    public void addPlaneOnScreen() {
        Vehicle p = new Plane();
        scene.addGameItem(p);
        vehicles.add( p);

    }
    public void addCarOnScreen() {
        Vehicle c = new Car();
        scene.addGameItem(c);
        vehicles.add(c);
    }
